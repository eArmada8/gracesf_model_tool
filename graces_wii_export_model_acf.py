# Tool to export model data from the model .acf files used by Tales of Graces (Wii).
...
try:
    ...
    from graces_wii_export_model import *
                ...
                if toc[i]['true_size'] > 0:
                    ...
                    if 'MDL' in toc[i]['name']:
                        with io.BytesIO(unc_data) as ff:
                            process_model_wii(ff, toc[i]['name'][:-4], overwrite = overwrite,
